window.onload = function () {
	...
	let HITBOX_WIDTH = 53;   //anchura definitiva que ocupa el personaje en el lienzo
	let HITBOX_HEIGHT = 107;	  //altura definitiva que ocupa el personaje en el lienzo
	...
	// METODOLOGÍA DE animacionActual
	// 0 = Estático en el Sitio
	// 1 = Caminando
	// 2 = Puñetazo

	let skinPersonaje = Ken;
	let arrayAnimacionPersonaje = [[[skinPersonaje.posicionX, skinPersonaje.posicionY],[54,18],[104,17],[153,16]],[[204,16],[251,16],[300,16],[350,16],[400,16]],[[169,129],[217,129],[273,129],[352,129],[410,129]]]; // Posiciones del sprite donde recortar cada imagen
	...
	let posicion = 0;
	let posicionAnimacion = 0;     //En desuso -> eliminar
	...
	Personaje.prototype.generaAnimacion = function() {
		...
		if(this.animacionActual === 2){ //Personaje dando puñetazo
			this.cantidadPosiciones = 5;
		// 	this.tamanioX = 73;
		// 	HITBOX_WIDTH = 73;
		// } else {
	...
	// QUIERO DISTINTOS setInterval con distintas velocidades para las distintas animaciones

	// QUIERO que al detectar cada tecla se le atribuya una velocidad de la animacion, que animacionActual, 
	// ya no tener que usar generaAnimacion y tampoco cantidadPosiciones sino que llamar a una u otro setInterval
	// para que haga muevePosicionAnimacion.

	// Y que al pulsar el botón de arriba (puñetazo) se active un temporizador y que mantenga la tecla de arriba un
	// cierto tiempo y que luego se vuelva a false. "Para que no se tenga que mantener la tecla presionada"
